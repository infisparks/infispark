...
const Cofounders = () => {
  ...
  return (
    <section className="py-16 bg-s2 transition-colors duration-300"> {/* Kept bg-s2 for dark mode */}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row md:justify-center md:space-x-8 space-y-12 md:space-y-0">
            {cofounders.map((cofounder, index) => (
              ...
              >
                <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-[#2EF2FF] to-[#3B54D9] opacity-10 group-hover:opacity-10 transition-opacity duration-300"></div> {/* Maintained dark mode gradient */}
